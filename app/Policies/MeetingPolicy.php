...
class MeetingPolicy
{
    ...
    {
        return $user->hasPermissionTo('view_any_meeting');
    }
    ...
    {
        return $user->hasPermissionTo('view_meeting');
    }
    ...
    {
        return $user->hasPermissionTo('restore_meeting');
    }
    ...
    {
        return $user->hasPermissionTo('force_meeting');
    }
}
